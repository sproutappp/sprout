...
// Realistic sample detail entries keyed by memory id
final Map<String, MemoryDetailData> _detailMap = {
  'm01': MemoryDetailData(
    memory: allMemories[0],
    caption:
        'We woke up at 4am to catch this. Freezing cold, barely awake — and then the sky just opened up. No words. Some moments you just have to be there for.',
    location: 'Mullayanagiri, Chikmagalur, Karnataka',
    taggedPeople: [
      _TaggedPerson(
        name: 'Arjun',
        avatarUrl:
      ...
      _TaggedPerson(
        ...
        semanticLabel: 'Young woman with long hair smiling in natural light',
      ),
      _TaggedPerson(
        name: 'Kiran',
        avatarUrl:
            'https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg?w=200',
        semanticLabel: 'Man with beard and casual shirt outdoors',
      ),
    ],
    reactions: [
      _Reaction(emoji: '❤️', count: 24),
      _Reaction(emoji: '🔥', count: 18),
      _Reaction(emoji: '😍', count: 11),
    ],
    commentCount: 7,
    comments: [
      _Comment(
        ...
        avatarUrl:
            'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?w=200',
        avatarSemanticLabel:
            'Young woman with long hair smiling in natural light',
        timestamp: '2h ago',
        text: 'This sunrise was absolutely worth waking up for 🌅',
        likeCount: 8,
      ),
      _Comment(
        name: 'Kiran',
        avatarUrl:
            'https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg?w=200',
        avatarSemanticLabel: 'Man with beard and casual shirt outdoors',
        timestamp: '5h ago',
        text:
            'I still can\'t believe we actually made it up there at 4am 😂 best decision ever',
        likeCount: 5,
      ),
      _Comment(
        name: 'Arjun',
        ...
        timestamp: 'Yesterday',
        text:
            'The cold was brutal but this view made everything worth it. Miss you guys already 🏔️',
        likeCount: 12,
      ),
    ],
  ),
  'm02': MemoryDetailData(
    memory: allMemories[1],
    caption:
        'Eighty years of love, laughter and the best food you\'ve ever tasted. Nani, you are the heart of this family. Here\'s to a hundred more.',
    ...
    taggedPeople: [
      _TaggedPerson(
        ...
        semanticLabel: 'Middle-aged woman with warm smile in festive attire',
      ),
      _TaggedPerson(
        name: 'Dad',
        avatarUrl:
            'https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpeg?w=200',
        semanticLabel: 'Middle-aged man in formal shirt smiling at camera',
      ),
      _TaggedPerson(
        name: 'Riya',
        avatarUrl:
            'https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg?w=200',
        semanticLabel: 'Young woman with braided hair and bright smile',
      ),
      _TaggedPerson(
        name: 'Rohan',
        avatarUrl:
            'https://images.pexels.com/photos/1043471/pexels-photo-1043471.jpeg?w=200',
        semanticLabel: 'Young man in casual shirt with cheerful expression',
      ),
    ],
    reactions: [
      _Reaction(emoji: '❤️', count: 52),
      _Reaction(emoji: '🥹', count: 31),
      _Reaction(emoji: '🎂', count: 14),
    ],
    commentCount: 19,
    comments: [
      _Comment(
        ...
        avatarUrl:
            'https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg?w=200',
        avatarSemanticLabel: 'Young woman with braided hair and bright smile',
        timestamp: '1d ago',
        text:
            'Nani looked so happy 🥹 this is the best memory we\'ve ever made as a family',
        likeCount: 21,
      ),
      _Comment(
        name: 'Rohan',
        avatarUrl:
            'https://images.pexels.com/photos/1043471/pexels-photo-1043471.jpeg?w=200',
        avatarSemanticLabel:
            'Young man in casual shirt with cheerful expression',
        timestamp: '1d ago',
        text: 'The food was incredible and Nani\'s smile said it all ❤️',
        likeCount: 14,
      ),
      _Comment(
        name: 'Mom',
        avatarUrl:
            'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?w=200',
        avatarSemanticLabel:
            'Middle-aged woman with warm smile in festive attire',
        timestamp: '2d ago',
        text:
            'So grateful we could all be together for this. Cherishing every moment 🙏',
        likeCount: 18,
      ),
    ],
  ),
  'm03': MemoryDetailData(
    memory: allMemories[2],
    caption:
        'It was 2am, the café was closing, and none of us wanted to leave. These are the nights that become the stories.',
    ...
    reactions: [
      _Reaction(emoji: '☕', count: 33),
      _Reaction(emoji: '🌙', count: 21),
      _Reaction(emoji: '❤️', count: 15),
    ],
    commentCount: 9,
    comments: [
      _Comment(
        ...
        avatarSemanticLabel:
            'Young woman with long hair smiling in natural light',
        timestamp: '3h ago',
        text: 'I still think about that chai at 2am. Nothing hits the same 🌙☕',
        likeCount: 9,
      ),
      _Comment(
        name: 'Dev',
        ...
        avatarSemanticLabel: 'Young man with short dark hair smiling outdoors',
        timestamp: '6h ago',
        text: 'We need to do this again soon. No excuses this time 😂',
        likeCount: 6,
      ),
    ],
  ),
...
class _MemoryDetailScreenState extends State<MemoryDetailScreen>
  ...
  void initState() {
    ...
    _detail = _detailMap[widget.memory.id] ?? _buildFallback(widget.memory);
